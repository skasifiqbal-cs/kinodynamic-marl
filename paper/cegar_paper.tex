...
$20$ runs this produced $13$ scored collision steps on a plan the verifier had accepted.
Replaying that plan's controls through the simulator reproduces all $13$: robot $8$ is parked at
step $408$, $0.18$\,m short of its planned stopping point, and robot $6$ passes through that
spot during steps $423$--$435$, where the plan had robot $8$ further on. The fix is to verify
under the simulator's parking rule (or disable it); until then,
