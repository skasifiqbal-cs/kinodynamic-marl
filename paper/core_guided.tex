...
Nothing in the method requires this: every bound is read from $\Rob_i$ individually and the
collision test in Def.~\ref{def:conflict} is already per-pair. Heterogeneous teams are a
