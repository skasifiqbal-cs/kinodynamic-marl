...
Env construction lives in `src.core.env.factory.build_env`, which is paradigm-neutral so
...
from src.core.networks import build_policy, build_value
...
def run_training(cfg: DictConfig) -> None:
    ...
    if num_envs > 1:
        ...
        from src.core.env.vec_multiagent import VecMultiAgentNav, VecPettingZooWrapper
